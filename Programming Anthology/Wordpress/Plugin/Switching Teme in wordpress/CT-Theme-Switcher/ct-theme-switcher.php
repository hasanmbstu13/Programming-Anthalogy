...
* Description: A custom plugin that switch theme depend on mobile & web platform
* Author: Mainul Hasan
...
function maybe_switch_theme($host = false)
{
	...
	$themes = array(
	'dhakatribune.local' => array('twentyfifteen','twentyfifteen'),
	'm.dhakatribune.local' => array('twentyfourteen','twentyfourteen') );
